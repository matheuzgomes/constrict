...
If you look at the source, it might look a bit weird. I intentionally avoided a lot of the modern Python "niceities" because of the hidden performance costs:
...
PS: This is just for fun, dont think youll be able to run this in your work.
```
